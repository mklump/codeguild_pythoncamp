...
def main():
    ...
    while accept_input:
        ...
        print('The numbers rolled for each dice was: {} {} {} {} {}'.format(dice['1'], dice['2'], dice['3'], dice['4'], dice['5']))
        print('The score tabulation for this roll attempt was: {} 1\'s {} 2\'s {} 3\'s {} 4\'s {} 5\'s {} 6\'s'.format(rolled['1'], rolled['2'], rolled['3'], rolled['4'], rolled['5'], rolled['6']))
