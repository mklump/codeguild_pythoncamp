 ...
 * @param {List} listToSearch as the list of integers to search through
 * @param {Number} sumToFind is an integer to find the sum of
 * @returns {List} the list of pairs found to be the sum of which to find
 */
